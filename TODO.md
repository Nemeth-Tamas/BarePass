...
* [x] Audit in-memory lifetime of usernames, passwords, notes, clipboard buffers, and temporary UI strings.
...
* [x] Design safe backup/recovery behavior for damaged or interrupted vault writes.
